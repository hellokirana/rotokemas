...
@section('content')
    <div class="container">
        <form method="POST" action="{{ url('data/layanan') }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-8">
                    <div class="card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <x-form.number label="harga_member" for="harga_member" name="harga_member"
                                        value="{{ old('harga_member') }}" :error="$errors->first('harga_member')" required></x-form.number>
                                </div>
                                <div class="col-md-6">
                                    <x-form.number label="harga_worker" for="harga_worker" name="harga_worker"
                                        value="{{ old('harga_worker') }}" :error="$errors->first('harga_worker')" required></x-form.number>
                                </div>
